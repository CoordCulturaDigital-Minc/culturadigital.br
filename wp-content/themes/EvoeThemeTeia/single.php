                                ...
                                <div class="posts bg">
                                    <ul class="posts">
                                        ...
                                        <li class="post">
                                            ...
                                            <p class="author"><?php echo __('por', 'evoeTheme') .': '; the_author_link(); echo ', '. __('em', 'evoeTheme') .' '; the_category(', '); echo ' '. __('no dia', 'evoeTheme') .' '; the_time('d/m/Y') ?> <span class="edit"><?php edit_post_link(__('Editar', 'evoeTheme'), '', ' &raquo;'); ?></span></p>
