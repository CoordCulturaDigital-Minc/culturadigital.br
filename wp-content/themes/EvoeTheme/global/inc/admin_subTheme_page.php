	...
	function admin_custom_page()
	{
		?>
			<div class="wrap custom_theme">
                <h2><?php _e('Opções do tema', 'evoeTheme'); ?></h2>
                ...
                <form class="custom_theme_form" action="<?php bloginfo('template_directory'); ?>/global/inc/admin_custom_theme.php" method="post" enctype="multipart/form-data">
                    <ul class="tabs">
                        ...
                        <li><a class="bt_general" href="#general_" class=""><?php _e('Geral', 'evoeTheme'); ?></a></li>
                    </ul>
                    ...
                    <div id="skins">
                    	<?php if( $this->bg['name'] ) : ?>
                        	<h4><?php _e('Tema ativo', 'evoeTheme'); ?>:</h4>
                        ...
                        <?php endif; ?>
                    	<h4><?php _e('Temas padrões', 'evoeTheme'); ?>:</h4>
                    ...
                    <div id="design">
                        ...
                        <div id="bg">
                            <div class="bgColor color">
                                <h4><?php _e('Escolha a cor do fundo(background)', 'evoeTheme'); ?>:</h4>
                                <ul>
                                    <li>
                            ...
                            <div class="upload">
                                <h4><?php _e('Escolha a imagem de fundo(background)', 'evoeTheme'); ?>:</h4>
                                <div id="uploadBg" class="uploadFromHD" <?php if(empty($this->bg['background']['url'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                    <label><?php _e('Tamanho máximo de 800kb. Formatos suportados: png, jpg, gif.', 'evoeTheme'); ?></label>
                                    <input type="hidden" name="MAX_FILE_SIZE" value="800000" />
                                    <input type="button" id="bgImage" value="<?php _e('Fazer upload', 'evoeTheme'); ?>" />
                                </div>
                                <div id="restoreBg" class="uploadFromHD" <?php if(!empty($this->bg['background']['url'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                    <label class="block"><?php _e('Restaurar imagem', 'evoeTheme'); ?>: </label>
                                    <input id="restoreBg" type="submit" name="restoreBg" value="<?php _e('Restaurar', 'evoeTheme'); ?>" />
                                </div>
                            </div>
                    		...
                    		<div class="bgOpt" <?php if(!empty($this->bg['background']['url'])) : ?>style="display:block; margin-top:-25px;"<?php else : ?>style="display:none; margin-top:-25px;"<?php endif; ?>>
	                            <h4 class="tit_"><?php _e('Opções da imagem de fundo(background)', 'evoeTheme'); ?>:</h4>
                                <div class="bgPosition">
                                    <h4><?php _e('Posicionamento', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li><label><input type="radio" name="bgPosition" value="center top" /> <?php _e('centro topo', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" value="center right" /> <?php _e('centro direita', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" value="center left" /> <?php _e('centro esquerda', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" value="center bottom" /> <?php _e('centro rodapé', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" checked="checked" value="left top" /> <?php _e('esquerda topo', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" value="left bottom" /> <?php _e('esquerda rodapé', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" value="right top" /> <?php _e('direita topo', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgPosition" value="right bottom" /> <?php _e('direita rodapé', 'evoeTheme'); ?></label></li>
                                    </ul>
                                </div>
                                <div class="bgRepeat">
                                    <h4><?php _e('Repetição', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li><label><input type="radio" name="bgRepeat" checked="checked" value="repeat" /> <?php _e('repetir', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgRepeat" value="repeat-x" /> <?php _e('repetir na horizontal', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgRepeat" value="repeat-y" /> <?php _e('repetir na vertical', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="bgRepeat" value="no-repeat" /> <?php _e('sem repetição', 'evoeTheme'); ?></label></li>
                                    </ul>
                                </div>
                                <div id="bgAttachment" class="bgRepeat">
                                    <h4><?php _e('Attachment', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li><label><input type="radio" name="bgAttachment" value="fixed" /> <?php _e('fixo', 'evoeTheme'); ?></label></li>
                        ...
                        <div id="headerDesign">
                        	<div  style="margin-left:15px;">
								<h4 style="margin-top:25px; margin-bottom:0;"><?php _e('Escolha a opacidade da barra de navegação', 'evoeTheme'); ?>:</h4>
                        	...
                        	<div class="titleDisplay">
                                <h4><?php _e('Mostrar o título do blog?', 'evoeTheme') ?></h4>
                                <ul>
                                    <li><label><input type="radio" checked="checked" name="headerTitle" value="0" /> <?php _e('sim', 'evoeTheme'); ?></label></li>
                                    <li><label><input type="radio" name="headerTitle" value="-999em" /> <?php _e('não', 'evoeTheme'); ?></label></li>
                                </ul>
                            </div>
                            
                            <div class="titleColor color" <?php if( $this->bg['header']['text'] == '-999em' ): ?> style="display:none" <?php endif; ?>>
                                <h4><?php _e('Escolha a cor do título', 'evoeTheme'); ?>:</h4>
                                <ul>
                                    <li>
                            ...
                            <div class="upload">
                                <h4><?php _e('Escolha a imagem do logotipo', 'evoeTheme'); ?>:</h4>
                                <div id="uploadLogo" class="uploadFromHD" <?php if(empty($this->bg['header']['logo'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                    <label><?php _e('Tamanho máximo de 800kb. Formatos suportados: png, jpg, gif. Resolução máxima: 960px x 125px', 'evoeTheme'); ?></label>
                                    <input type="hidden" name="MAX_FILE_SIZE" value="800000" />
                                    <input type="button" id="logoImage" value="<?php _e('Fazer upload', 'evoeTheme'); ?>" />
                                </div>
                                <div id="restoreLogo" class="uploadFromHD" <?php if(!empty($this->bg['header']['logo'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                    <label class="block"><?php _e('Restaurar imagem', 'evoeTheme'); ?>: </label>
                                    <input id="retoreLogo" type="submit" name="restoreLogo" value="<?php _e('Restaurar', 'evoeTheme'); ?>" />
                                </div>
                            </div>
                			<h4 class="tit_"><?php _e('Opções da imagem de fundo(background)', 'evoeTheme'); ?>:</h4>
                            <div id="logoPosition" class="bgPosition" <?php if(!empty($this->bg['header']['logo'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                <h4><?php _e('Posicionamento do logotipo', 'evoeTheme'); ?>:</h4>
                                <ul>
                                    <li><label><input type="radio" name="logoPosition" value="center" /> <?php _e('centro', 'evoeTheme'); ?></label></li>
                                    <li><label><input type="radio" name="logoPosition" value="left center" checked="checked" /> <?php _e('esquerda', 'evoeTheme'); ?></label></li>
                                    <li><label><input type="radio" name="logoPosition" value="right center" /> <?php _e('direita', 'evoeTheme'); ?></label></li>
                                </ul>
                            </div>
                            ...
                            <div class="headerColor color">
                                <h4><?php _e('Escolha a cor do cabeçalho', 'evoeTheme'); ?>:</h4>
                                <ul>
                                    <li>
                            ...
                            <div class="upload">
                                <h4><?php _e('Escolha a imagem de fundo(background) do cabeçalho', 'evoeTheme'); ?>:</h4>
                                <div id="uploadHeader" class="uploadFromHD" <?php if(empty($this->bg['header']['image'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                    <label><?php _e('Tamanho máximo de 800kb. Formatos suportados: png, jpg, gif. Resolução máxima: 1920px x 125px', 'evoeTheme'); ?></label>
                                    <input type="hidden" name="MAX_FILE_SIZE" value="800000" />
                                    <input type="button" id="headerImage" value="<?php _e('Fazer upload', 'evoeTheme'); ?>" />
                                </div>
                                <div id="restoreHeader" class="uploadFromHD" <?php if(!empty($this->bg['header']['image'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                    <label class="block"><?php _e('Restaurar imagem', 'evoeTheme'); ?>: </label>
                                    <input id="retoreHeader" type="submit" name="restoreHeader" value="<?php _e('Restaurar', 'evoeTheme'); ?>" />
                                </div>
                            </div>
                    
                    		<div id="headerOpt" <?php if(!empty($this->bg['header']['image'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                            	<h4 class="tit_"><?php _e('Opções da imagem de fundo(background) do cabeçalho', 'evoeTheme'); ?></h4>
                                <div id="headerPosition" class="bgPosition">
                                    <h4><?php _e('Posicionamento', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li><label><input type="radio" name="headerPosition" value="center top" /> <?php _e('centro topo', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" value="center right" /> <?php _e('centro direita', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" value="center left" /> <?php _e('centro esquerda', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" value="center bottom" /> <?php _e('centro rodapé', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" checked="checked" value="left top" /> <?php _e('esquerda topo', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" value="left bottom" /> <?php _e('esquerda rodapé', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" value="right top" /> <?php _e('direita topo', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerPosition" value="right bottom" /> <?php _e('direita rodapé', 'evoeTheme'); ?></label></li>
                                    </ul>
                                </div>
                                <div id="headerRepeat" class="bgRepeat">
                                    <h4><?php _e('Repetição', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li><label><input type="radio" name="headerRepeat" checked="checked" value="repeat" /> <?php _e('repetir', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerRepeat" value="repeat-x" /> <?php _e('repetir na horizontal', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerRepeat" value="repeat-y" /> <?php _e('repetir na vertical', 'evoeTheme'); ?></label></li>
                                        <li><label><input type="radio" name="headerRepeat" value="no-repeat" /> <?php _e('sem repetição', 'evoeTheme'); ?></label></li>
                                    </ul>
                                </div>
                                <div class="clear"></div>
                            </div>
                        ...
                        <div id="content">
                            <div class="boxOpt">
                                <div id="boxColor" class="boxColor color">
                                    <h4><?php _e('Escolha a cor de fundo da caixa de título', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li>
                                ...
                                <div id="textColor" class="textColor color">
                                    <h4><?php _e('Escolha a cor de texto da caixa de título', 'evoeTheme'); ?>:</h4>
                                    <ul>
                                        <li>
                                ...
                                <div id="pattern" class="pattern">
                                	<div id="patternOpt" <?php if(empty($this->bg['box']['patternId'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                        <h4><?php _e('Escolha um efeito(pattern) para a caixa de título', 'evoeTheme'); ?>:</h4>
                                        <ul>
                                            <li>
                                    ...
                                    <div class="patternImage">
                                        <h4><?php _e('Escolha uma imagem para o efeito(pattern) na caixa de título', 'evoeTheme'); ?>:</h4>
                                        <div id="uploadPattern" class="uploadFromHD" <?php if(empty($this->bg['box']['patternId'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                            <label><?php _e('Tamanho máximo de 150kb. Formatos suportados: png, jpg, gif. Resolução máxima: 630px x 36px', 'evoeTheme'); ?></label>
                                            <input type="hidden" name="MAX_FILE_SIZE" value="150000" />
                                            <input type="button" id="patternImage" value="<?php _e('Fazer upload', 'evoeTheme'); ?>" />
                                        </div>
                                        <div id="restorePattern" class="uploadFromHD" <?php if(!empty($this->bg['box']['patternId'])) : ?>style="display:block;"<?php else : ?>style="display:none;"<?php endif; ?>>
                                            <label class="block"><?php _e('Restaurar imagem', 'evoeTheme'); ?>: </label>
                                            <input id="restorePattern" type="submit" name="restorePattern" value="<?php _e('Restaurar', 'evoeTheme'); ?>" />
                                        </div>
                                    </div>
                                    <h4><?php _e('Escolha a opacidade do efeito(pattern) da caixa de título', 'evoeTheme'); ?>:</h4>
                            ...
                            <div id="linkColor" class="linkColor color">
                                <h4><?php _e('Escolha a cor dos links do blog', 'evoeTheme'); ?>:</h4>
                                <ul>
                                    <li>
                    ...
                    <div id="general_">
                    	<div class="category_">
                    		<label for="hlCategory"><?php _e('Escolha uma categoria para o destaque', 'evoeTheme'); ?>:</label>
                    ...
                    <div class="buttons">
                        <input type="submit" name="restore" class="bt_restore" value="<?php _e('Restaurar', 'evoeTheme'); ?>" />
                        <input type="hidden" class="action_" name="action_" />
                        <input type="submit" name="action" class="bt_save" value="<?php _e('Salvar', 'evoeTheme'); ?>" />
                    </div>
                </form>
            </div>
        </div>
