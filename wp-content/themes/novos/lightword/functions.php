...
/*    array(  "name" => __('Christmas Joy','lightword'),
    ...
    array(  "name" => __('Wordpress 3.0 Menus','lightword'),
			"desc" => __('From v1.9.9.6 LightWord does offer support for Wordpress 3.0 Menus.<br/>Currently <em>beta</em>, some features may not work as it should.','lightword'),
            "id" => $shortname."_wp3_menus",
            "type" => "checkbox",
            "std" => "false"),
    ...
    array(  "name" => __('Custom image header','lightword'),
			"desc" => __('Check this box if you would like to SHOW IMAGE instead of Cuf&oacute;n text on header.<br/>Image location: <code>lightword/images/header-image.png</code> / Max width: <code>796px</code><br/><br/><em>After this option is selected a new option will be revealed. Guess what? Image height! :)</em>','lightword'),
...
<div class="stuffbox">
<h3><label for="link_url"><?php _e('Search for help','lightword'); ?> (<a href="http://www.lightworddesign.com/">blog</a> <?php _e('or','lightword'); ?> <a href="http://twitter.com/andreiluca">twitter</a>)</label></h3>
<div class="inside">
...
echo '<p>Thanks for using LightWord theme.<br/>Check out the new features available in v1.9.9.6!<div style="float:right;">';
...
if($lw_wp3_menus=="true"){
if ( function_exists( 'register_nav_menus' ) ) register_nav_menus(array('lightword_top' => __('LightWord Menu', 'lightword')));
}
/*
