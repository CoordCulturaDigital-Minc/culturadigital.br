...
<html xmlns="http://www.w3.org/1999/xhtml" <?php language_attributes(); ?>>
	<head>
	<link type="text/css" href="http://www.culturadigital.br/wp-content/themes/cultura_digital/css/map.css" rel="stylesheet" media="screen" />
		...
		<script type="text/javascript" src="http://www.culturadigital.br/wp-content/themes/cultura_digital/js/markerclusterer_packed.js"></script>
		<script type="text/javascript">
			...
			function pointMembers()
			{
				...
				<?php
					...
					$members = $wpdb->get_col("SELECT ID FROM {$wpdb->users} ORDER BY RAND() LIMIT 10");
					...
					//foreach($members['users'] as $omember) : // Apenas membros online
						...
						$user_link        = bp_core_get_userurl($member);
						...
						if(!empty($user_zip) || !empty($user_city)) :
							?>
							    ...
							    cluster = new MarkerClusterer(map, markers);
									...
									member = "<img src='<?php print $user_avatar; ?>' style='float:left; margin:0px 5px 5px 0px;'><strong><a href='<?php print $user_link; ?>' target='_parent'><?php print $user_name; ?></a></strong><br><?php print $user_description; ?>";
	...
	<body onload="Inicialize()" onunload="GUnload()" style="margin:0px; padding:0px; font:12px Arial, Helvetica, sans-serif;">
		<div id="map" style="width:471px; height:245px; margin:0px;"></div>
	</body>
</html>
