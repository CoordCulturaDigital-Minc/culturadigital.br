...
{
	//header("Location: http://culturadigital.br/maintenance");
	//exit;
}
?>
		            ...
		            <div class="middle">
		                <ul class="nav">
               				<li<?php if ( bp_is_page( 'home' ) && !is_page() ) : ?> class="current_page_item"<?php endif; ?>>
                				<a href="<?php echo site_url() ?>" title="<?php _e( 'Página Inicial', 'buddypress' ) ?>"><?php _e( 'Página Inicial', 'buddypress' ) ?></a>
                            </li>
            				<?php // wp_list_pages( 'title_li=&exclude=1896,1919,1921' ); ?>

							<li><a href="/sobre/">Sobre</a></li>
							<li><a href="/conceito-de-cultura-digital/">Conceito</a></li>
							<li><a href="/documentos/">Acervo</a></li>
