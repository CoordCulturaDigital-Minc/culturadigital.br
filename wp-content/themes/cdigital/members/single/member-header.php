...
<div id="item-header-content">
	...
	<?php if (function_exists('get_user_openids') && get_user_openids(bp_displayed_user_id())) : ?>
		<br /><span class="activity">Este usuário usa o <a href="<?php echo IDDACULTURA_PROVIDER;?>">ID da Cultura</a></span>
	<?php endif; ?>
	<?php endif; ?>
