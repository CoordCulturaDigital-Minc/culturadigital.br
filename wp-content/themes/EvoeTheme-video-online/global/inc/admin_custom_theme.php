<?php
    ...
    if($_POST['action'] === 'restoreBg')
    {
		...
		{
			echo __('Background image restored!', 'evoeTheme');
		}
    }
    ...
    elseif($_POST['action'] === 'restoreLogo')
    {
		...
		{
			echo __('Logo image restored!', 'evoeTheme');
		}
    }
    ...
    elseif($_POST['action'] === 'restoreHeader')
    {
		...
		{
			echo __('Header image restored!', 'evoeTheme');
		}
    }
    ...
    elseif($_POST['action'] === 'restorePattern')
    {
		...
		{
			echo __('Pattern image restored!', 'evoeTheme');
		}
    }
	...
	elseif($_POST['action'] === 'restore')
	{
		...
		echo __('Theme restored!', 'evoeTheme');
	}
    ...
    elseif($_POST['action'] === 'save')
    {
        ...
        echo __('Theme updated!', 'evoeTheme');
    }
?>
