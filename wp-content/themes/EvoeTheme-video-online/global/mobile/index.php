    ...
    <body <?php body_class() ?>>
        <div id="general">
            ...
            <div id="content" class="mid">
                <ul class="tabs">
                	<li class="active"><a href="<?php bloginfo('url'); ?>"><?php _e('Recent posts', 'evoeTheme')?></a></li>
                    <li><a href="<?php bloginfo('url'); ?>?popularposts=1"><?php _e('Popular posts', 'evoeTheme')?></a></li>
                </ul>
                <ul class="posts">
					<?php
						$cont = 0;
            ...
            <div id="content" class="mid">
                <ul class="tabs">
                	<li><a href="<?php bloginfo('url'); ?>"><?php _e('Recent posts', 'evoeTheme')?></a></li>
                    <li class="active popularposts"><a href="<?php bloginfo('url'); ?>?popularposts=1"><?php _e('Popular posts', 'evoeTheme')?></a></li>
                </ul>
                <ul class="posts">
					<?php
						global $wpdb;
                    ...
                    ?>
                        <li <?php echo $cont == 1 ? 'class="first"' : '' ?>>
                            <div class="cat">
                                <a href="<?php echo get_permalink($postid); ?>"><?php echo $commentcount; ?> <?php _e('View|plural', 'evoeTheme')?>.</a>
                            </div>
