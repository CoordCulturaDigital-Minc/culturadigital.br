  ...
  ************************************************************************************************/
  function painter_custom_colors_scripts()
  {
    ...
    if(function_exists('wp_enqueue_style'))
      wp_enqueue_style('farbtastic', get_bloginfo('stylesheet_directory') . '/js/jquery.farbtastic-1.2.js', array(), '1.2');
    else
      $this->painter_custom_colors_styles();
  }
  
  /************************************************************************************************
    Styles
  ************************************************************************************************/
  function painter_custom_colors_styles()
  {
    // Get the stylesheet_directory
    $stylesheet_directory = get_bloginfo('stylesheet_directory');
    
    // scripts
    print "<link type='text/css' href='{$stylesheet_directory}/css/jquery.farbtastic-1.2.css' rel='stylesheet' media='screen' />";
  }
