...
<div id="content">
        ...
        <?php while($highlights->have_posts()) : $highlights->the_post(); ?>
          ...
          <div>
            ...
            <div class="info">
              ...
              <span><?php _e('on', 'painter'); ?> <?php the_time(get_option('date_format')); ?></span>
  ...
  <?php if(have_posts()) : ?>
    ...
    <?php elseif($show_session_title == 1) : ?>
    ...
    <?php while(have_posts()) : the_post(); ?>
      ...
      <div class="post">
        ...
        <div class="info">
          ...
          <?php if($show_comments == 1) : ?><p class="post-comments"><?php comments_popup_link(__('Leave a comment', 'painter'), __('1 comment', 'painter'), __('% comments', 'painter')); ?></a></p><?php endif; ?>
        </div>
      </div>
    <?php endwhile; ?>
  ...
  <div class="navigation">
    <div class="alignleft"><?php next_posts_link(__('&laquo; Older', 'painter')); ?></div>
    <div class="alignright"><?php previous_posts_link(__('Newer &raquo;', 'painter')); ?></div>
  </div>
