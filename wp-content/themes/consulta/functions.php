 ...
 */
add_action('wp_print_styles', 'consulta_wp_print_styles', 20);

function consulta_wp_print_styles() {
 ...
 */
add_action('wp_ajax_object_evaluation', 'consulta_wp_ajax_object_evaluation ');

function consulta_wp_ajax_object_evaluation() {
