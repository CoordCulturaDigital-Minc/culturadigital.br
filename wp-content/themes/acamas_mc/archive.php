...
<?php /* the_tags(__('Tags:', 'kubrick'), ', ', '<br />'); */ ?> <?php edit_post_link('Discutir este item', '', ' | '); ?>  <?php comments_popup_link(__('No Comments &#187;', 'kubrick'), __('1 Comment &#187;', 'kubrick'), __('% Comments &#187;', 'kubrick'), '', __('Comments Closed', 'kubrick') ); ?></p>
