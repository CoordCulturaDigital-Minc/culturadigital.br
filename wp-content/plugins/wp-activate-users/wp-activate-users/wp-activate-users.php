...
<?php			
	...
	<div id="activatorMU<?php echo $userMU->user_login; ?>" style="display: none;">
		<form action="?action=wpmu-activate" method="post">
			...
			<input type="hidden" name="key" value="<?php echo $userMU->activation_key; ?>">	
			<input type="submit" value="Confirm">
		</form>
	</div>
	<?php
...
echo "</div>";
	...
	?>
	&nbsp;&nbsp;<a href="<?php echo $_SERVER['PHP_SELF']; ?>?page=wp-activate-users">REFRESH THIS PAGE TO UPDATE USER LIST</a>
	<br><br>	
