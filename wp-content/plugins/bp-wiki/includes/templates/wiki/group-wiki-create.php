<div class="checkbox">
	<label><input type="checkbox" value="1" id="groupwiki-enable-wiki" name="groupwiki-enable-wiki" onclick="jQuery('#wiki-create-fields, #wiki-create-fields-instructions').toggleClass('wiki-hidden');"/> <?php _e( 'Enable group wiki', 'bp-wiki' ); ?></label>	
	<hr>
</div>
...
<div id="wiki-create-fields" class="wiki-hidden">
	...
	<input type="radio" name="wiki-privacy" value="public" checked="checked"/>
	  <strong><?php _e( 'Public', 'bp-wiki' ); ?>
	    </strong><?php _e( ' - Wiki pages are viewable to all site visitors.', 'bp-wiki' ); ?><br/>
	<input type="radio" name="wiki-privacy" value="member-only" />
	  <strong><?php _e( 'Private', 'bp-wiki' ); ?>
	    </strong><?php _e( ' - Wiki pages may only be viewed by members of the group.', 'bp-wiki' ); ?><br/>
