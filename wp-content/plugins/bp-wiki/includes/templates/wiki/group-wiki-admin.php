...
<div style="clear:both;"></div>
	...
	<div class="checkbox">
		<label>
			<input 
				type="checkbox" id="groupwiki-member-page-create" name="groupwiki-member-page-create" value="yes" 
				<?php if ( groups_get_groupmeta( $bp->groups->current_group->id, 'bp_wiki_group_wiki_member_page_create' ) == 'yes' ) echo 'checked="1"'; ?>
			/>
