			...
			<?php foreach ( (array) $users['users'] as $user ) : ?>
				<li class="vcard">
					<div class="item-avatar">
						<a href="<?php echo bp_core_get_userlink( $user->user_id, false, true ) ?>" title="<?php echo bp_core_get_username( $user->user_id ) ?> - <?php echo bp_core_get_last_activity( $user->user_registered, __( 'registered %s ago', 'buddypress' ) ) ?>"><?php echo bp_core_get_avatar( $user->user_id, 1 ) ?></a>
					</div>
