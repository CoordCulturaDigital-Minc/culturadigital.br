		...
		<ul id="groups-list" class="item-list">
				...
				<li>
					...
					<div class="item-avatar">
						<a href="<?php echo bp_get_group_permalink( $group ) ?>" title="<?php echo $group->name ?>"><img src="<?php echo $group->avatar_thumb; ?>" alt="<?php echo $group->name ?> Avatar" class="avatar" align="left" /></a> 
						<h5><a href="<?php echo bp_get_group_permalink( $group ) ?>" title="<?php echo $group->name ?>"><?php echo $group->name ?></a></h5>
						<span class="activity">
							<?php 
