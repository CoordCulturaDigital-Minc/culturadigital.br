...
var VideoJS = Class.extend({
  ...
  init: function(element, num){
    ...
    this.videoOrigZIndex = this.parentWindow.document.getElementById('videoPlayer').style.zIndex;
    this.videoParentOrigWidth = this.parentWindow.document.getElementById('videoPlayer').style.width;
    this.videoParentOrigHeight = this.parentWindow.document.getElementById('videoPlayer').style.height;	
  },
  ...
  fullscreenOn: function(){	
    ...
    this.video.style.width = this.parentWindow.window.innerWidth + "px";
    this.video.style.height = this.parentWindow.window.innerHeight + "px";
	...
	this.parentWindow.document.getElementById('videoPlayer').style.width = this.parentWindow.window.innerWidth + "px";
	this.parentWindow.document.getElementById('videoPlayer').style.height = this.parentWindow.window.innerHeight + "px";
	this.parentWindow.document.getElementById('videoPlayer').style.position = "fixed";
	this.parentWindow.document.getElementById('videoPlayer').style.left = 0;
	this.parentWindow.document.getElementById('videoPlayer').style.top = 0;
	this.parentWindow.document.getElementById('videoPlayer').style.zIndex = 999;
	this.parentWindow.document.body.style.overflow = "hidden";		
  ...
  fullscreenOff: function(){
	...
	this.parentWindow.document.getElementById('videoPlayer').style.width = this.videoParentOrigWidth + "px";
	this.parentWindow.document.getElementById('videoPlayer').style.height = this.videoParentOrigHeight + "px";
	this.parentWindow.document.getElementById('videoPlayer').style.position = "static";
	this.parentWindow.document.getElementById('videoPlayer').style.zIndex = this.videoOrigZIndex;
	this.parentWindow.document.body.style.overflow = "auto";	
